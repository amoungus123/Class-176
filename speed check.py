# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 20:20:32 2023
...
label_download = Label(root, text="Download Speed ↓", font=("Seoge Print", 18, "bold"), fg="#1E8449", bg="#dee8f1")
label_download.place(relx=0.25, rely=0.5, anchor=CENTER)

label_upload = Label(root, text="Upload Speed ↑", font=("Seoge Print", 18, "bold"), fg="#9B59B6", bg="#dee8f1")
...
btn_check = Button(root, text="Check Speed", command=speedCheck,bg="#218796", fg="White",relief = FLAT)
